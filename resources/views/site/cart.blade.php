            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="cart">
                        ...
                        <h1 class="cart-title">In Your Shopping Cart: <span class="c-primary"> {{ session()->get('cart') ? count(session('cart')) : 0 }}</span></h1>
                    ...
                    <div class="cart-total">
                        ...
                        <h5 class="cart-total-total">Total: <span class="price">${{ $cartTotal }}</span></h5>
