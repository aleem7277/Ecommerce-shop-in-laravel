            ...
            <ul class="nav-add">
                <li class="cart">
                    ...
                    <a href="#" class="js-cart-animate">
                        ...
                        <span class="cart-count cart_total_items">{{ session()->get('cart') ? count(session('cart')) : 0 }}</span>
                    </a>

                    <div class="cart-popup-wrap">
                        <div class="popup-cart">
                            <h4 class="title-cart"><span class="cart_total_items">{{ session()->get('cart') ? count(session('cart')) : 0 }}</span> products in the cart!</h4>
...
<script src="{{asset('assets/site/js/nimation.velocity.min.js')}}a"></script>
